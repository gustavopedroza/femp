...
$v_tit = 'Administra��o de Eventos';

$v_url = 'https://expoaltotiete.com.br/ad_ss';
$v_url_site = 'https://expoaltotiete.com.br/';
$pasta_upload = "../downloads/";
$caminho_server = "/home/u139844934/domains/expoaltotiete.com.br/public_html/downloads/";
...
function email($para_email, $para_nome, $assunto, $html) {
	...
	$mail2->Subject = $assunto;
	$mail2->AltBody = "Para ver essa mensagem, use um programa compat�vel com HTML!"; // optional, comment out and test
	$mail2->MsgHTML($html);
	if ($mail2->Send()) {
		return 1;
	} else {
